<section id="main-content">
  ...
  <div class="panel-heading">List of Added Reastaurant &nbsp; Add More Restaurant</div>
...
<?php } ?>
    <div class="row w3-res-tb">
      <div class="col-sm-12 col-md-12 col-xs-12 m-b-xs">
   		 <div class="heading-r underline-rest">Add More Restaurant</div>
<?php echo form_open("", array( 'id' => 'add_mart_form'));?>
          ...
          <input id="restaurantname" type="text" class="form-control" name="name" placeholder="Enter Restaurant Name" maxlength="20" value="<?php echo set_value('name')?>" required >
          </div>
         ...
         <div class="input-group">
          ...
          <input id="number" type="number" class="form-control" name="phone" placeholder="Enter Contact Number" pattern="^\d{10}$" value="<?php echo set_value('phone')?>" required >
         </div>
    ...
    <?php// pr($detail);?>
      <div class="col-sm-12 col-md-12 col-xs-12 m-b-xs">
           ...
           <input id="product_name" type="text" class="form-control" name="food_name" placeholder="Enter Product Name" maxlength="100" value="<?php echo set_value('food_name')?>" required  >
           </div>
           <?php echo form_error('food_name','<label class="alert-danger">','</label>');?>
           </div>
