...
<?php }?>
    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-12 col-md-12 col-xs-12 m-b-xs">
        <?php   echo form_open("admin/category/addCategory", array('id'=>"category_add_form"));?>
         ...
         <div class="input-group">
          ...
          <input type="hidden" name="category_type" value="<?php echo 1 ;?>" >
          <input id="categoryname" type="text" class="form-control" name="category_name" placeholder="Categories Name" value="<?php echo set_value('category_name')?>" maxlength ="10" required >
