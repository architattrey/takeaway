...
<section id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <div class="tab-r tab-active-r"><a  href="<?php echo base_url().$this->uri->segment(1)?>/Cms">Terms And Conditions</a></div>
    </div>
    <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12 padding-0px">
...
<?php } ?>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10"><div class="terms">Terms And Conditions</div></div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-2"><div class="edit-icon"></div></div>
  <form action="<?php echo base_url().$this->uri->segment(1)."/cms/updateTermsAndConditions";?>" method="post">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 conrt-mrg">
                ...
                <div class="content-para" >
                    <input type="hidden" name="id" value="<?php echo $this->Common_model->encrypt($para['id']);?>">
                     <textarea name="terms_and_conditions" id="editor1" rows="8" cols="180" class="checkeditor" required><?php echo isset($para['terms_and_conditions'])?$para['terms_and_conditions']:"NA";?>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2017 Visitors. All rights reserved | Design by <a href="javascript:void(0)">ChromeInfotech</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
