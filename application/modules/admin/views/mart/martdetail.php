<section id="main-content">
  ...
  <div class="panel panel-default" style="padding-bottom:20px;">
    <div class="panel-heading">List of Added Mart &nbsp;  <?php echo isset($detail['name'])?$detail['name']:"NA";?> </div>
    <div class="row">
    ...
    <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 m-b-xs">
               ...
               <div class=""><img src="http://res.cloudinary.com/http-flynaut-com/image/upload/c_scale,h_360,w_1200<?php echo $detail['banner_img_path'];?>" class="img-responsive" id="img-preview" alt="image not found"></div>
       ...
       <div class="main-info">
            ...
            <div class="iconn">
            <div class="heading-r">Mart Name</div>
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12"><div class="add-morr-r"><a href="<?php echo base_url().$this->uri->segment(1)."/mart/addProduct?name=". $detail['name'];?>">Add More Products</a></div></div>
