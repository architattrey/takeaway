...
<section id="main-content">
  ...
  <div class="panel-heading">Update For <?php echo $detail['name'];?> Mart</div>
...
<?php echo form_open("admin/mart/updateMart", array( 'id' => 'add_mart_form'));?>
          ...
          <input id="martname" type="text" class="form-control" name="name" placeholder="Enter Mart Name" maxlength="20" value="<?php echo $detail['name']; ?>" required >
          </div>
         ...
         <div class="input-group">
          ...
          <input id="number" type="number" class="form-control" name="phone" placeholder="Enter Phone Number" maxlength="13" value="<?php echo $detail['phone'];?>" required >
         </div>
