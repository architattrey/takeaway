<section id="main-content">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">List of Registered Driver</div>
    ...
    <form method="GET">
      <div class="col-sm-5 m-b-xs">
        ...
        <button type="button" class="btn btn-sm btn-default" onclick="window.location.href='<?php echo base_url().$this->uri->segment(1)?>/driver'">Reset</button>                 
      </div>
      <div class="col-sm-4">
      </div>
      <div class="col-sm-3">
      ...
      <table  cellpadding="10">
        ...
        ?>            
                      <tr>
                        ...
                        <td><?php echo $val['wallet_credit'];?></td>
